                ...
                <div style="float:left; width:100%; " class="table-c">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        <tr class="mm">
                            ...
                            <td align="center" class="mm">Channel Wavelength</td>
                            <td align="center" class="mm">Adjacent channel isolation</td>
                            <td align="center" class="mm">Non-Adjacent channel isolation</td>
                            <td align="center" class="mm">Insertion Loss</td>
